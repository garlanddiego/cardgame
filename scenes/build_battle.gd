...
func _initialize() -> void:
	...
	# Energy display (bottom left) with semi-transparent panel
	var energy_panel = PanelContainer.new()
	energy_panel.name = "EnergyPanel"
	energy_panel.position = Vector2(50, 820)
	energy_panel.custom_minimum_size = Vector2(100, 60)
	var energy_style = StyleBoxFlat.new()
	energy_style.bg_color = Color(0.1, 0.1, 0.2, 0.7)
	energy_style.border_color = Color(0.3, 0.5, 0.9, 0.8)
	energy_style.border_width_left = 2
	energy_style.border_width_right = 2
	energy_style.border_width_top = 2
	energy_style.border_width_bottom = 2
	energy_style.corner_radius_top_left = 8
	energy_style.corner_radius_top_right = 8
	energy_style.corner_radius_bottom_left = 8
	energy_style.corner_radius_bottom_right = 8
	energy_style.content_margin_left = 8
	energy_style.content_margin_right = 8
	energy_style.content_margin_top = 4
	energy_style.content_margin_bottom = 4
	...
	end_turn_btn.position = Vector2(1720, 820)
