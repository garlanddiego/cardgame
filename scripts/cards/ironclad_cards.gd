...
static func get_cards() -> Dictionary:
	...
	# POWERS (14 cards)
	# =========================================================================
	db["ic_demon_form"] = {"id": "ic_demon_form", "name": "Demon Form", "cost": 3, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "At the start of\neach turn, gain 2\nStrength.", "art": "", "target": "self", "hero_target": "target_hero", "power_effect": "demon_form", "per_turn": {"strength": 2}, "power_stacks": 2, "actions": [{"type": "power_effect", "power": "demon_form"}]}
	db["ic_corruption"] = {"id": "ic_corruption", "name": "Corruption", "cost": 3, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "Skills cost 0.\nWhenever you play a\nSkill, Exhaust it.", "art": "", "target": "self", "power_effect": "corruption", "skills_cost_zero": true, "power_stacks": 1, "actions": [{"type": "power_effect", "power": "corruption"}]}
	db["ic_berserk"] = {"id": "ic_berserk", "name": "Berserk", "cost": 0, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "Gain 1 Vulnerable.\nAt the start of each\nturn, gain 1 Energy.", "art": "", "target": "self", "power_effect": "berserk", "per_turn": {"energy": 1}, "power_stacks": 1, "power_self_debuff": {"type": "vulnerable", "stacks": 1}, "actions": [{"type": "power_effect", "power": "berserk"}]}
	db["ic_feel_no_pain"] = {"id": "ic_feel_no_pain", "name": "Feel No Pain", "cost": 1, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "Whenever a card is\nExhausted, gain\n3 Block.", "art": "", "target": "self", "hero_target": "target_hero", "power_effect": "feel_no_pain", "power_stacks": 3, "actions": [{"type": "power_effect", "power": "feel_no_pain"}]}
	db["ic_juggernaut"] = {"id": "ic_juggernaut", "name": "Juggernaut", "cost": 2, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "Whenever you gain\nBlock, deal 5 damage\nto a random enemy.", "art": "", "target": "self", "hero_target": "target_hero", "power_effect": "juggernaut", "power_stacks": 5, "actions": [{"type": "power_effect", "power": "juggernaut"}]}
	db["ic_evolve"] = {"id": "ic_evolve", "name": "Evolve", "cost": 1, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "Whenever you draw a\nStatus card, draw 1.", "art": "", "target": "self", "power_effect": "evolve", "power_stacks": 1, "actions": [{"type": "power_effect", "power": "evolve"}]}
	db["ic_rage"] = {"id": "ic_rage", "name": "Rage", "cost": 0, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "Whenever you play an\nAttack this turn,\ngain 3 Block.", "art": "", "target": "self", "hero_target": "target_hero", "power_effect": "rage", "power_stacks": 3, "actions": [{"type": "power_effect", "power": "rage"}]}
	db["ic_barricade"] = {"id": "ic_barricade", "name": "Barricade", "cost": 3, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "Block is not removed\nat the start of\nyour turn.", "art": "", "target": "self", "hero_target": "target_hero", "power_effect": "barricade", "retain_block": true, "power_stacks": 1, "actions": [{"type": "power_effect", "power": "barricade"}]}
	db["ic_inflame"] = {"id": "ic_inflame", "name": "Inflame", "cost": 1, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "Gain 2 Strength.", "art": "", "target": "self", "hero_target": "all_heroes", "apply_self_status": {"type": "strength", "stacks": 2}, "actions": [{"type": "apply_self_status", "status": "strength", "stacks": 2}]}
	db["ic_metallicize"] = {"id": "ic_metallicize", "name": "Metallicize", "cost": 1, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "At the end of your\nturn, gain 3 Block.", "art": "", "target": "self", "hero_target": "target_hero", "power_effect": "metallicize", "per_turn": {"block": 3}, "power_stacks": 3, "actions": [{"type": "power_effect", "power": "metallicize"}]}
	db["ic_brutality"] = {"id": "ic_brutality", "name": "Brutality", "cost": 0, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "At the start of your\nturn, lose 1 HP and\ndraw 1 card.", "art": "", "target": "self", "power_effect": "brutality", "per_turn": {"self_damage": 1, "draw": 1}, "power_stacks": 1, "actions": [{"type": "power_effect", "power": "brutality"}]}
	db["ic_combust"] = {"id": "ic_combust", "name": "Combust", "cost": 1, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "At the end of your\nturn, lose 1 HP and\ndeal 5 damage to ALL\nenemies.", "art": "", "target": "self", "power_effect": "combust", "per_turn": {"self_damage": 1, "damage_all": 5}, "power_stacks": 5, "actions": [{"type": "power_effect", "power": "combust"}]}
	db["ic_dark_embrace"] = {"id": "ic_dark_embrace", "name": "Dark Embrace", "cost": 2, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "Whenever a card is\nExhausted, draw 1.", "art": "", "target": "self", "power_effect": "dark_embrace", "power_stacks": 1, "actions": [{"type": "power_effect", "power": "dark_embrace"}]}
	db["ic_rupture"] = {"id": "ic_rupture", "name": "Rupture", "cost": 1, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "Whenever you lose HP\nfrom a card, gain\n1 Strength.", "art": "", "target": "self", "power_effect": "rupture", "power_stacks": 1, "actions": [{"type": "power_effect", "power": "rupture"}]}
	db["ic_fire_breathing"] = {"id": "ic_fire_breathing", "name": "Fire Breathing", "cost": 1, "type": CardType.POWER, "character": "ironclad", "damage": 0, "block": 0, "description": "Whenever you draw a\nStatus or Curse, deal\n6 damage to ALL.", "art": "", "target": "self", "power_effect": "fire_breathing", "power_stacks": 6, "actions": [{"type": "power_effect", "power": "fire_breathing"}]}
...
static func get_upgrade_overrides() -> Dictionary:
	return {
		...
		"ic_flex": {"flex_stacks": 4, "hero_target": "all_heroes", "description": "Gain 4 Strength.\nAt end of turn,\nlose 4 Strength."},
		...
		"ic_power_through": {"block": 20, "hero_target": "target_hero", "description": "Gain 20 Block.\nAdd 2 Wounds to\nyour hand."},
		...
		"ic_ghostly_armor": {"block": 13, "hero_target": "target_hero", "description": "Ethereal.\nGain 13 Block."},
		...
		"ic_sentinel": {"block": 8, "hero_target": "target_hero", "description": "Gain 8 Block.\nIf this card is\nExhausted, gain\n3 Energy."},
		...
		# POWERS
		"ic_demon_form": {"hero_target": "target_hero", "description": "At the start of\neach turn, gain 3\nStrength.", "power_effect": "demon_form_plus", "per_turn": {"strength": 3}, "power_stacks": 3},
		"ic_corruption": {"cost": 2, "description": "Skills cost 0.\nWhenever you play a\nSkill, Exhaust it."},
		"ic_berserk": {"description": "Gain 1 Vulnerable.\nAt the start of each\nturn, gain 2 Energy.", "power_effect": "berserk_plus", "per_turn": {"energy": 2}, "power_stacks": 2},
		"ic_feel_no_pain": {"hero_target": "target_hero", "description": "Whenever a card is\nExhausted, gain\n4 Block.", "power_effect": "feel_no_pain_plus", "power_stacks": 4},
		"ic_juggernaut": {"hero_target": "target_hero", "description": "Whenever you gain\nBlock, deal 7 damage\nto a random enemy.", "power_effect": "juggernaut_plus"},
		"ic_evolve": {"description": "Whenever you draw a\nStatus card, draw 2.", "power_effect": "evolve_plus"},
		"ic_rage": {"hero_target": "target_hero", "description": "Whenever you play an\nAttack this turn,\ngain 5 Block.", "power_effect": "rage_plus"},
		"ic_barricade": {"cost": 2, "hero_target": "target_hero", "description": "Block is not removed\nat the start of\nyour turn."},
		"ic_inflame": {"apply_self_status": {"type": "strength", "stacks": 3}, "hero_target": "all_heroes", "description": "Gain 3 Strength."},
		"ic_metallicize": {"hero_target": "target_hero", "description": "At the end of your\nturn, gain 4 Block.", "power_effect": "metallicize_plus", "per_turn": {"block": 4}, "power_stacks": 4},
