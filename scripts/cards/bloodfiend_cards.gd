...
static func get_cards() -> Dictionary:
	...
	db["bf_predator_instinct"] = {"id": "bf_predator_instinct", "name": "掠食本能", "cost": 1, "type": CardType.SKILL, "character": "bloodfiend", "damage": 0, "block": 0, "description": "本回合每打出\n1张攻击牌，\n获得3点格挡。\n抽1张牌。", "art": "res://assets/img/card_art/bf_predator_instinct.png", "target": "self", "version": "new", "hero_target": "self", "draw": 1, "power_effect": "predator_instinct", "power_stacks": 3, "actions": [{"type": "draw"}, {"type": "power_effect", "power": "predator_instinct"}]}
	db["bf_bloodbath"] = {"id": "bf_bloodbath", "name": "血浴", "cost": 1, "type": CardType.SKILL, "character": "bloodfiend", "damage": 0, "block": 0, "description": "消耗1张手牌。\n施加2层嗜血\n和1层易伤。", "art": "res://assets/img/card_art/bf_bloodbath.png", "target": "enemy", "version": "new", "hero_target": "self", "bf_bloodlust_apply": 2, "apply_status": {"type": "vulnerable", "stacks": 1}, "actions": [{"type": "call", "fn": "bloodbath"}]}
	db["bf_blood_pact"] = {"id": "bf_blood_pact", "name": "血契", "cost": 1, "type": CardType.SKILL, "character": "bloodfiend", "damage": 0, "block": 0, "description": "消耗1张手牌。\n抽2张牌。", "art": "res://assets/img/card_art/bf_blood_pact.png", "target": "self", "version": "new", "hero_target": "self", "draw": 2, "actions": [{"type": "call", "fn": "blood_pact"}]}
	...
	db["bf_crimson_pact"] = {"id": "bf_crimson_pact", "name": "绯红契约", "cost": 1, "type": CardType.POWER, "character": "bloodfiend", "damage": 0, "block": 0, "description": "每当一张牌被\n消耗，对随机\n敌人造成5点伤害。", "art": "res://assets/img/card_art/bf_crimson_pact.png", "target": "self", "version": "new", "hero_target": "self", "power_effect": "crimson_pact", "power_stacks": 5, "actions": [{"type": "power_effect", "power": "crimson_pact"}]}
