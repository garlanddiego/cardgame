...
static func get_cards() -> Dictionary:
	...
	db["bf_frenzy_claw"] = {"id": "bf_frenzy_claw", "name": "狂乱之爪", "cost": 1, "type": CardType.ATTACK, "character": "bloodfiend", "damage": 4, "block": 0, "description": "随机对敌人\n造成4点伤害3次。", "art": "res://assets/img/card_art/bf_frenzy_claw.png", "target": "random_enemy", "version": "new", "times": 3, "rarity": "common", "actions": [{"type": "call", "fn": "frenzy_claw"}]}
	...
	db["bf_predator_instinct"] = {"id": "bf_predator_instinct", "name": "掠食本能", "cost": 1, "type": CardType.SKILL, "character": "bloodfiend", "damage": 0, "block": 0, "description": "本回合每打出\n1张攻击牌，\n获得2点格挡。\n抽1张牌。", "art": "res://assets/img/card_art/bf_predator_instinct.png", "target": "self", "version": "new", "hero_target": "self", "draw": 1, "power_effect": "predator_instinct", "power_stacks": 2, "rarity": "uncommon", "actions": [{"type": "draw"}, {"type": "power_effect", "power": "predator_instinct"}]}
