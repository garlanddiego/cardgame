...
static func get_cards() -> Dictionary:
	...
	db["bf_blood_feast"] = {"id": "bf_blood_feast", "name": "血宴", "cost": 1, "type": CardType.ATTACK, "character": "bloodfiend", "damage": 7, "block": 0, "description": "造成7点伤害。\n若击杀目标，\n获得3点最大HP。\n消耗。", "art": "res://assets/img/card_art/bf_blood_feast.png", "target": "enemy", "version": "new", "exhaust": true, "max_hp_gain": 3, "actions": [{"type": "call", "fn": "blood_feast"}]}
	db["bf_desperate_duel"] = {"id": "bf_desperate_duel", "name": "拼死决斗", "cost": 1, "type": CardType.ATTACK, "character": "bloodfiend", "damage": 6, "block": 0, "description": "获得2点力量。\n敌人获得1点力量。\n造成6点伤害。", "art": "res://assets/img/card_art/bf_desperate_duel.png", "target": "enemy", "version": "new", "bf_self_str": 2, "bf_enemy_str": 1, "actions": [{"type": "call", "fn": "desperate_duel"}]}
	...
	db["bf_blood_offering"] = {"id": "bf_blood_offering", "name": "血祭", "cost": 0, "type": CardType.SKILL, "character": "bloodfiend", "damage": 0, "block": 0, "description": "失去5点HP。\n获得2点能量。\n抽2张牌。\n消耗。", "art": "res://assets/img/card_art/bf_blood_offering.png", "target": "self", "version": "new", "hero_target": "self", "exhaust": true, "actions": [{"type": "self_damage", "value": 5}, {"type": "gain_energy", "value": 2}, {"type": "draw", "value": 2}]}
	db["bf_predator_instinct"] = {"id": "bf_predator_instinct", "name": "掠食本能", "cost": 1, "type": CardType.SKILL, "character": "bloodfiend", "damage": 0, "block": 0, "description": "本回合每打出\n1张攻击牌，\n获得2点格挡。\n抽1张牌。", "art": "res://assets/img/card_art/bf_predator_instinct.png", "target": "self", "version": "new", "hero_target": "self", "draw": 1, "power_effect": "predator_instinct", "power_stacks": 2, "actions": [{"type": "draw"}, {"type": "power_effect", "power": "predator_instinct"}]}
	db["bf_sacrifice"] = {"id": "bf_sacrifice", "name": "献祭", "cost": 0, "type": CardType.SKILL, "character": "bloodfiend", "damage": 0, "block": 0, "description": "失去3点HP。\n获得2点能量。", "art": "res://assets/img/card_art/bf_sacrifice.png", "target": "self", "version": "new", "hero_target": "self", "actions": [{"type": "self_damage", "value": 3}, {"type": "gain_energy", "value": 2}]}
	db["bf_bloodrage"] = {"id": "bf_bloodrage", "name": "嗜血狂怒", "cost": 1, "type": CardType.SKILL, "character": "bloodfiend", "damage": 0, "block": 0, "description": "所有英雄失去2点HP。\n对所有敌人施加\n1层易伤。\n获得2点临时力量。", "art": "res://assets/img/card_art/bf_bloodrage.png", "target": "all_enemies", "version": "new", "hero_target": "self", "flex_stacks": 2, "actions": [{"type": "call", "fn": "bloodrage"}]}
	...
	db["bf_blood_rush"] = {"id": "bf_blood_rush", "name": "血涌", "cost": 1, "type": CardType.SKILL, "character": "bloodfiend", "damage": 0, "block": 0, "description": "选择手中1张攻击牌\n本场战斗降低1费。\n消耗。", "art": "res://assets/img/card_art/bf_blood_rush.png", "target": "self", "version": "new", "hero_target": "self", "exhaust": true, "actions": [{"type": "call", "fn": "blood_rush"}]}
	...
	db["bf_survival_instinct"] = {"id": "bf_survival_instinct", "name": "求生本能", "cost": 0, "type": CardType.SKILL, "character": "bloodfiend", "damage": 0, "block": 3, "description": "获得3点格挡。\nHP低于25%时，\n改为获得6点。", "art": "res://assets/img/card_art/bf_survival_instinct.png", "target": "self", "version": "new", "hero_target": "target_hero", "actions": [{"type": "call", "fn": "survival_instinct"}]}
	...
	db["bf_sanguine_aura"] = {"id": "bf_sanguine_aura", "name": "血气光环", "cost": 2, "type": CardType.POWER, "character": "bloodfiend", "damage": 0, "block": 0, "description": "每当你造成攻击\n伤害，对目标\n施加1层嗜血。", "art": "res://assets/img/card_art/bf_sanguine_aura.png", "target": "self", "version": "new", "hero_target": "self", "power_effect": "sanguine_aura", "power_stacks": 1, "actions": [{"type": "power_effect", "power": "sanguine_aura"}]}
	db["bf_blood_scent"] = {"id": "bf_blood_scent", "name": "血之气息", "cost": 1, "type": CardType.POWER, "character": "bloodfiend", "damage": 0, "block": 0, "description": "每当你施加\n易伤，抽\n1张牌。", "art": "res://assets/img/card_art/bf_blood_scent.png", "target": "self", "version": "new", "hero_target": "self", "power_effect": "blood_scent", "power_stacks": 1, "actions": [{"type": "power_effect", "power": "blood_scent"}]}
	db["bf_pain_threshold"] = {"id": "bf_pain_threshold", "name": "痛觉阈值", "cost": 1, "type": CardType.POWER, "character": "bloodfiend", "damage": 0, "block": 0, "description": "每当你失去HP，\n抽1张牌并\n获得3点格挡。", "art": "res://assets/img/card_art/bf_pain_threshold.png", "target": "self", "version": "new", "hero_target": "target_hero", "power_effect": "pain_threshold", "power_stacks": 3, "actions": [{"type": "power_effect", "power": "pain_threshold"}]}
