...
static func get_cards() -> Dictionary:
	...
	db["bf_sanguine_aura"] = {"id": "bf_sanguine_aura", "name": "血气光环", "cost": 2, "type": CardType.POWER, "character": "bloodfiend", "damage": 0, "block": 0, "description": "每当你造成攻击\n伤害，对目标\n施加1层嗜血。", "art": "res://assets/img/card_art/bf_sanguine_aura.png", "target": "self", "version": "new", "hero_target": "target_hero", "power_effect": "sanguine_aura", "power_stacks": 1, "rarity": "common", "actions": [{"type": "power_effect", "power": "sanguine_aura"}]}
