...
static func get_cards() -> Dictionary:
	...
	db["si_deflect"] = {"id": "si_deflect", "name": "Deflect", "cost": 0, "type": CardType.SKILL, "character": "silent", "damage": 0, "block": 4, "description": "Gain 4 Block.", "art": "", "target": "self", "hero_target": "target_hero", "actions": [{"type": "block"}]}
