...
static func get_cards() -> Dictionary:
	...
	db["fg_forge_slam"] = {"id": "fg_forge_slam", "name": "锻击猛击", "cost": 2, "type": CardType.ATTACK, "character": "forger", "damage": 8, "block": 0, "description": "巨剑造成8点伤害。\n巨剑获得未被\n格挡的生命值。", "art": "res://assets/img/card_art/fg_forge_slam.png", "target": "enemy", "version": "new", "rarity": "uncommon", "actions": [{"type": "call", "fn": "forge_slam"}]}
	...
	db["fg_reinforce"] = {"id": "fg_reinforce", "name": "加固", "cost": 2, "type": CardType.SKILL, "character": "forger", "damage": 0, "block": 0, "description": "巨剑获得等同于\n其当前生命70%\n的额外生命。", "art": "res://assets/img/card_art/fg_reinforce.png", "target": "self", "version": "new", "hero_target": "self", "rarity": "uncommon", "fg_reinforce_pct": 70, "actions": [{"type": "call", "fn": "reinforce"}]}
	...
	db["fg_sword_sacrifice"] = {"id": "fg_sword_sacrifice", "name": "剑之牺牲", "cost": 1, "type": CardType.ATTACK, "character": "forger", "damage": 0, "block": 0, "description": "对所有敌人造成\n10点伤害。\n目标英雄获得\n巨剑生命+10\n的格挡。消耗巨剑。", "art": "res://assets/img/card_art/fg_sword_sacrifice.png", "target": "self", "version": "new", "hero_target": "target_hero", "rarity": "rare", "fg_sacrifice_dmg": 10, "fg_sacrifice_block_bonus": 10, "actions": [{"type": "call", "fn": "sword_sacrifice"}]}
...
static func get_upgrade_overrides() -> Dictionary:
	return {
		...
		"fg_forge_slam": {"damage": 12, "description": "巨剑造成12点伤害。\n巨剑获得未被\n格挡的生命值。"},
		...
		"fg_reinforce": {"fg_reinforce_pct": 100, "description": "巨剑获得等同于\n其当前生命100%\n的额外生命。"},
		...
		"fg_sword_sacrifice": {"fg_sacrifice_dmg": 13, "fg_sacrifice_block_bonus": 13, "description": "对所有敌人造成\n13点伤害。\n目标英雄获得\n巨剑生命+13\n的格挡。消耗巨剑。"},
