...
static func get_cards() -> Dictionary:
	...
	db["fg_sacrifice_fuel"] = {"id": "fg_sacrifice_fuel", "name": "献燃", "cost": 0, "type": CardType.SKILL, "character": "forger", "damage": 0, "block": 0, "description": "消耗巨剑8点生命\n或英雄8点格挡，\n获得1点能量。\n不足8则无法打出。", "art": "res://assets/img/card_art/fg_sacrifice_fuel.png", "target": "self", "version": "new", "hero_target": "target_hero", "rarity": "common", "fg_sacrifice_cost": 8, "fg_energy_gain": 1, "actions": [{"type": "call", "fn": "sacrifice_fuel"}]}
